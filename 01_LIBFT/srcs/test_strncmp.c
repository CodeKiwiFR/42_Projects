...
/*   Updated: 2023/11/09 10:37:34 by mhotting         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_strncmp(void)
{
	...
	// Test 5
	lib_res = strncmp("Hello", "Hel", 3);
	my_res = ft_strncmp("Hello", "Hel", 3);
	test_result = lib_res == my_res;
	print_test_infos(cpt++, test_result, 0);
	...
	// Test 10
	lib_res = strncmp("Hello", "Zello", 6);
	my_res = ft_strncmp("Hello", "Zello", 6);
	test_result = lib_res == my_res;
